var SDKComponent = function(React2) {
  ...
  const FinStatement = ({ context, prompts, data, drillDown }) => {
    var _a2, _b, _c;
    console.log(data);
    let curyr = (_a2 = data.data[0].at(3)) == null ? void 0 : _a2.value;
    let curyr2 = parseFloat(curyr);
    console.log(curyr);
    console.log(curyr2);
    const dims = (_c = (_b = data.rowHeaders) == null ? void 0 : _b.map((cell) => {
